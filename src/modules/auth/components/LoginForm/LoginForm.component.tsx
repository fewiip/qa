...
export const LoginForm: FunctionComponent<LoginFormProps> = (props) => {
  ...
  return (
    <div className={styles.loginCard}>
      <Input placeholder="E-mail ou nome do usuário" type="text" value={email} onChange={(i) => setEmail(i.target.value)} /> {/* transformar em componente */}
      <Input placeholder="Senha" type="password" value={password} onChange={(i) => setPassword(i.target.value)} /> {/* transformar em componente */}
